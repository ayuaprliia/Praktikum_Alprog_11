//Program Nilai Akhir - Kelompok 11
//Laksmi Putri Kusuma - 2205551149
...
int main(){
    ...
    do{
        ...
        kehadiran = input();
        if ((kehadiran > 16 || (kehadiran < 0))){
            printf("\n\n\t\t\t\t\tJumlah Kehadiran Tidak Sesuai");
            printf("\n\t\t\t\t\tMohon Input Angka 0-16\n");
            sleep(3);
            system("cls");
            ulangi =1 ;
        }else {
